  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-md p-4">
        ...
        <p className="text-sm text-gray-600 mb-3">
          Look outside your home. If you see a large unit with a fan on top, that is likely your outdoor condenser (split system). 
          If all the equipment is in one outdoor unit, it is probably a package system.
        </p>
        <div className="flex items-center text-sm text-blue-600">
          <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          Still not sure? Select I do not know and we will help you identify your system.
        </div>
      </div>
