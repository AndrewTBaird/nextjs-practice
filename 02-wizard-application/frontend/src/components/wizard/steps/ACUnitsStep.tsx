            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-amber-800">
                  For homes with more than 3 AC units, we will need to discuss your specific needs. Our team will contact you to provide a customized quote.
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-800">
                  No problem! Our experts can help you determine your current system setup. We will contact you to discuss your home cooling needs.
                </p>
              </div>
            </div>
          </CardContent>
